...
module.exports = {
  ...
  module: {
    rules: [{ // Regras utilizadas pelo webpack. Esse é um arraye de objetos e como no momento só estamos trabalhando 
  ...
  devtool: 'source-map', // Como utilizamos o babel e o webpack para criar um 
